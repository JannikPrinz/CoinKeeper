...
static const std::string TEXT_CHOOSE_TARGET_ACCOUNT_FOR_TRANSACTION = "Bitte w\303\244hlen Sie ein Ziel-Konto aus, auf dem die entgegengesetzte Transaktion ausgef\303\274hrt werden soll.";
...
static const std::string TEXT_QUESTION_MODIFY_ACCOUNT_AT_TRANSACTION_DELETION = "Die Transaktion wird gel\303\266scht.\nSoll die \303\204nderung des entsprechenden Kontos auch r\303\274ckg\303\244ngig gemacht werden?";
